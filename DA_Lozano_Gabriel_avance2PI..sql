...
-- ¿Cual es la cantidad total de registros unicos en la tabla de Órdenes
...
-- ¿Cuáles son las sucursales con un promedio de facturación/ingresos superior a 1000.0 y que minimizan sus costos en base al promedio de kilométros recorridos de todas de sus entregas gestionadas? Para un mejor relevamiento, ordene el listado por promedio Km Recorridos.
